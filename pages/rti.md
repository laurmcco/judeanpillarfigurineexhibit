...
{% include feature/collapse.html button="Where is the circular mark on this figurine's surface?" color="outline-info" text="The pupil. What do you think could have caused it? Now that you see this mark, switch into the default/”light” mode. What color paint fills the circular mark? You have just discovered that RTI shows color not only chromatically but through imprints left on the surface, invisible to the naked eye. There is a similar circular mark in the other eye, though more faint. Now that you have some experience manipulating a virtual light and observing this artifact's surface topography, can you find the circular pupil mark in the other eye? It is hard to detect, but it is there!" %}
...
View the remaining 2 RTI images of this artifact to compare views of the pupils, and anything else you would like to see." %}
